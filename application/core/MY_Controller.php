...
{
  /**
	 * Inisiasi controller MY_Controller
	 *
	 * @author	Ari Susanto
	 */
  public $title = 'Informasi Informatika Ilmu Komputer';
	...
	public function template($data, $role = 'home')
	{
		return $this->load->view($role.'/template/layout',$this->data);
	}
