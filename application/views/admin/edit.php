...
<div id="content">
    ...
    ?>
    <?=form_open('admin/edit_post?id='.$id.'&cat='.$cat)?>
        ...
        <div class="panel">
          <div class="panel-heading">
           ...
           <div class="row">
              <div class="col-lg-12">
                    <input type="text" class="form-control fileupload-v1-path" name="title" value="<?=$data->post_title?>">
              </div><!-- /.col-lg-6 -->
            </div><!-- /.row -->
	        </div>
	      </div>
	      ...
	      <div class="panel">
	        <div class="panel-body">
              <textarea id="text_data" name="data"><?=$data->post_content?></textarea>
              <br>
